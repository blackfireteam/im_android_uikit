...
public class IMUikitUnionTypeMapper extends UnionTypeLoadingStatus {
    ...
    public static final int UNION_TYPE_IMPL_IM_MESSAGE_RTC_RECEIVED = sNextUnionType++; // 聊天消息-接收的 rtc 信息
    ...
    public static final int UNION_TYPE_IMPL_IM_MESSAGE_CUSTOM_EMOTION_RECEIVED = sNextUnionType++; // 聊天消息-接收的自定义表情信息
    public static final int UNION_TYPE_IMPL_IM_MESSAGE_CUSTOM_EMOTION_SEND = sNextUnionType++; // 聊天消息-发送的自定义表情信息
