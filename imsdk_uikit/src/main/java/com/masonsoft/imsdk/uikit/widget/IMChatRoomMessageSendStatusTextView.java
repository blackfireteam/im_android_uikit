...
public class IMChatRoomMessageSendStatusTextView extends FrameLayout {

    public IMChatRoomMessageSendStatusTextView(Context context) {
        this(context, null);
    }

    public IMChatRoomMessageSendStatusTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public IMChatRoomMessageSendStatusTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public IMChatRoomMessageSendStatusTextView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setChatRoomMessage(@Nullable MSIMChatRoomMessage message) {
        if (message == null) {
    ...
    private CharSequence buildStatusText(@NonNull MSIMChatRoomMessage message) {
