...
import com.masonsoft.imsdk.uikit.databinding.ImsdkUikitUnionTypeImplImBaseMessageCustomLikeSendBinding;
...
public class IMBaseMessageCustomLikeSendViewHolder extends IMBaseMessageCustomLikeViewHolder {

    private final ImsdkUikitUnionTypeImplImBaseMessageCustomLikeSendBinding mBinding;

    public IMBaseMessageCustomLikeSendViewHolder(@NonNull Host host) {
        super(host, R.layout.imsdk_uikit_union_type_impl_im_base_message_custom_like_send);
        mBinding = ImsdkUikitUnionTypeImplImBaseMessageCustomLikeSendBinding.bind(itemView);
    }
