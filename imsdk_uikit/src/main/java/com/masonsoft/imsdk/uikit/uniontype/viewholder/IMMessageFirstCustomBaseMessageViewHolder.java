...
@Deprecated
public abstract class IMMessageFirstCustomBaseMessageViewHolder extends IMBaseMessageViewHolder {

    private final TextView mMessageText;

    public IMMessageFirstCustomBaseMessageViewHolder(@NonNull Host host, int layout) {
        super(host, layout);
        mMessageText = itemView.findViewById(R.id.message_text);
    }

    public IMMessageFirstCustomBaseMessageViewHolder(@NonNull Host host, @NonNull View itemView) {
        super(host, itemView);
        mMessageText = itemView.findViewById(R.id.message_text);
    }
    ...
    public void onBindUpdate() {
        ...
        GestureDetectorCompat gestureDetectorCompat = new GestureDetectorCompat(mMessageText.getContext(), new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onDoubleTap(MotionEvent e) {
                ...
                if (listener != null) {
                    listener.onItemClick(IMMessageFirstCustomBaseMessageViewHolder.this);
                }
                return true;
            }
        });
