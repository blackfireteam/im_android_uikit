...
import com.masonsoft.imsdk.uikit.databinding.ImsdkUikitUnionTypeImplImBaseMessageFirstCustomMessageSendBinding;
...
@Deprecated
public class IMMessageFirstCustomBaseMessageSendViewHolder extends IMMessageFirstCustomBaseMessageViewHolder {

    private final ImsdkUikitUnionTypeImplImBaseMessageFirstCustomMessageSendBinding mBinding;

    public IMMessageFirstCustomBaseMessageSendViewHolder(@NonNull Host host) {
        super(host, R.layout.imsdk_uikit_union_type_impl_im_base_message_first_custom_message_send);
        mBinding = ImsdkUikitUnionTypeImplImBaseMessageFirstCustomMessageSendBinding.bind(itemView);
    }
