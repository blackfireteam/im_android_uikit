...
import com.masonsoft.imsdk.uikit.databinding.ImsdkUikitUnionTypeImplImBaseMessageCustomEmotion2SendBinding;
...
public class IMBaseMessageCustomEmotion2SendViewHolder extends IMBaseMessageCustomEmotion2ViewHolder {

    private final ImsdkUikitUnionTypeImplImBaseMessageCustomEmotion2SendBinding mBinding;

    public IMBaseMessageCustomEmotion2SendViewHolder(@NonNull Host host) {
        super(host, R.layout.imsdk_uikit_union_type_impl_im_base_message_custom_emotion2_send);
        mBinding = ImsdkUikitUnionTypeImplImBaseMessageCustomEmotion2SendBinding.bind(itemView);
    }
