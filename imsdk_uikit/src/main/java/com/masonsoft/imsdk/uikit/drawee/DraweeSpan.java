...
public class DraweeSpan extends BetterImageSpan {
    ...
    private final DraweeSpanStringBuilder mUnsafeRef;

    public DraweeSpan(
            DraweeHolder draweeHolder, @BetterImageSpan.BetterImageSpanAlignment int verticalAlignment, DraweeSpanStringBuilder unsafeRef) {
        super(draweeHolder.getTopLevelDrawable(), verticalAlignment);
        mDraweeHolder = draweeHolder;

        mUnsafeRef = unsafeRef;
    }
