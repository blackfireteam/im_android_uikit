...
import com.masonsoft.imsdk.uikit.databinding.ImsdkUikitUnionTypeImplImBaseMessageRtcSendBinding;
...
public class IMBaseMessageRtcSendViewHolder extends IMBaseMessageRtcViewHolder {

    private final ImsdkUikitUnionTypeImplImBaseMessageRtcSendBinding mBinding;

    public IMBaseMessageRtcSendViewHolder(@NonNull Host host) {
        super(host, R.layout.imsdk_uikit_union_type_impl_im_base_message_rtc_send);
        mBinding = ImsdkUikitUnionTypeImplImBaseMessageRtcSendBinding.bind(itemView);
    }
