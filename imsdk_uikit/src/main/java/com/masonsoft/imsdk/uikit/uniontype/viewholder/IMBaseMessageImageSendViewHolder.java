...
import com.masonsoft.imsdk.uikit.databinding.ImsdkUikitUnionTypeImplImBaseMessageImageSendBinding;
...
public class IMBaseMessageImageSendViewHolder extends IMBaseMessageImageViewHolder {

    private final ImsdkUikitUnionTypeImplImBaseMessageImageSendBinding mBinding;

    public IMBaseMessageImageSendViewHolder(@NonNull Host host) {
        super(host, R.layout.imsdk_uikit_union_type_impl_im_base_message_image_send);
        mBinding = ImsdkUikitUnionTypeImplImBaseMessageImageSendBinding.bind(itemView);
    }
